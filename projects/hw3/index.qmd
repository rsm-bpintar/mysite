...
1. **Data Simulation**: Instead of assigning one fixed set of $\beta$ values to all respondents, we would draw individual-level parameters from a population distribution:

\[
\beta_i \sim \mathcal{N}(\mu, \Sigma)
\]

This would better reflect individual variation in preferences.
